...
export const EndpointApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createOrUpdate: async (appId: string, endpointIn: EndpointIn, idempotencyKey?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('createOrUpdate', 'appId', appId)
            // verify required parameter 'endpointIn' is not null or undefined
            assertParamExists('createOrUpdate', 'endpointIn', endpointIn)
         ...
         * @throws {RequiredError}
         */
        getDetails: async (appId: string, endpointId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('getDetails', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('getDetails', 'endpointId', endpointId)
         ...
         * @throws {RequiredError}
         */
        getSigningSecret: async (appId: string, endpointId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('getSigningSecret', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('getSigningSecret', 'endpointId', endpointId)
         ...
         * @throws {RequiredError}
         */
        getStatistics: async (appId: string, endpointId: string, since?: string, until?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('getStatistics', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('getStatistics', 'endpointId', endpointId)
         ...
         * @throws {RequiredError}
         */
        resendFailedMessages: async (appId: string, endpointId: string, recoverIn: RecoverIn, idempotencyKey?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('resendFailedMessages', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('resendFailedMessages', 'endpointId', endpointId)
            // verify required parameter 'recoverIn' is not null or undefined
            assertParamExists('resendFailedMessages', 'recoverIn', recoverIn)
         ...
         * @throws {RequiredError}
         */
        sendExampleMessageType: async (appId: string, endpointId: string, eventExampleIn: EventExampleIn, idempotencyKey?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('sendExampleMessageType', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('sendExampleMessageType', 'endpointId', endpointId)
            // verify required parameter 'eventExampleIn' is not null or undefined
            assertParamExists('sendExampleMessageType', 'eventExampleIn', eventExampleIn)
         ...
         * @throws {RequiredError}
         */
        setWebhookHeaders: async (appId: string, endpointId: string, endpointHeadersIn: EndpointHeadersIn, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('setWebhookHeaders', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('setWebhookHeaders', 'endpointId', endpointId)
            // verify required parameter 'endpointHeadersIn' is not null or undefined
            assertParamExists('setWebhookHeaders', 'endpointHeadersIn', endpointHeadersIn)
            const localVarPath = `/api/v1/app/{app_id}/endpoint/{endpoint_id}/headers`
                .replace(`{${"app_id"}}`, encodeURIComponent(String(appId !== undefined ? appId : `-app_id-`)))
                .replace(`{${"endpoint_id"}}`, encodeURIComponent(String(endpointId !== undefined ? endpointId : `-endpoint_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        updateEndpointById: async (appId: string, endpointId: string, endpointUpdate: EndpointUpdate, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('updateEndpointById', 'appId', appId)
            // verify required parameter 'endpointId' is not null or undefined
            assertParamExists('updateEndpointById', 'endpointId', endpointId)
            // verify required parameter 'endpointUpdate' is not null or undefined
            assertParamExists('updateEndpointById', 'endpointUpdate', endpointUpdate)
            const localVarPath = `/api/v1/app/{app_id}/endpoint/{endpoint_id}`
                .replace(`{${"app_id"}}`, encodeURIComponent(String(appId !== undefined ? appId : `-app_id-`)))
                .replace(`{${"endpoint_id"}}`, encodeURIComponent(String(endpointId !== undefined ? endpointId : `-endpoint_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const EndpointApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Create a new endpoint for the application.  When `secret` is `null` the secret is automatically generated (recommended)
         * @summary Create Endpoint
         * @param {EndpointApiCreateOrUpdateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createOrUpdate(requestParameters: EndpointApiCreateOrUpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EndpointOut>> {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.createOrUpdate(requestParameters.appId, endpointIn, requestParameters.idempotencyKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get an endpoint.
         * @summary Get Endpoint
         * @param {EndpointApiGetDetailsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getDetails(requestParameters: EndpointApiGetDetailsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EndpointOut>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDetails(requestParameters.appId, requestParameters.endpointId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get the additional headers to be sent with the webhook
         ...
         * Get the endpoint\'s signing secret.  This is used to verify the authenticity of the webhook. For more information please refer to [the consuming webhooks docs](https://docs.svix.com/consuming-webhooks/).
         * @summary Get Endpoint Secret
         * @param {EndpointApiGetSigningSecretRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSigningSecret(requestParameters: EndpointApiGetSigningSecretRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EndpointSecretOut>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSigningSecret(requestParameters.appId, requestParameters.endpointId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get basic statistics for the endpoint.
         * @summary Endpoint Stats
         * @param {EndpointApiGetStatisticsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getStatistics(requestParameters: EndpointApiGetStatisticsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EndpointStats>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getStatistics(requestParameters.appId, requestParameters.endpointId, requestParameters.since, requestParameters.until, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get the transformation code associated with this endpoint
         ...
         * Resend all failed messages since a given time.
         * @summary Recover Failed Webhooks
         * @param {EndpointApiResendFailedMessagesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async resendFailedMessages(requestParameters: EndpointApiResendFailedMessagesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecoverOut>> {
            const recoverIn: RecoverIn = {
                since: requestParameters.since,
                until: requestParameters.until
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.resendFailedMessages(requestParameters.appId, requestParameters.endpointId, recoverIn, requestParameters.idempotencyKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Rotates the endpoint\'s signing secret.  The previous secret will be valid for the next 24 hours.
         ...
         * Send an example message for event
         * @summary Send Event Type Example Message
         * @param {EndpointApiSendExampleMessageTypeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async sendExampleMessageType(requestParameters: EndpointApiSendExampleMessageTypeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessageOut>> {
            const eventExampleIn: EventExampleIn = {
                eventType: requestParameters.eventType
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.sendExampleMessageType(requestParameters.appId, requestParameters.endpointId, eventExampleIn, requestParameters.idempotencyKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Set or unset the transformation code associated with this endpoint
         ...
         * Set the additional headers to be sent with the webhook
         * @summary Update Endpoint Headers
         * @param {EndpointApiSetWebhookHeadersRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async setWebhookHeaders(requestParameters: EndpointApiSetWebhookHeadersRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const endpointHeadersIn: EndpointHeadersIn = {
                headers: requestParameters.headers
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.setWebhookHeaders(requestParameters.appId, requestParameters.endpointId, endpointHeadersIn, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update an endpoint.
         * @summary Update Endpoint
         * @param {EndpointApiUpdateEndpointByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateEndpointById(requestParameters: EndpointApiUpdateEndpointByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EndpointOut>> {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateEndpointById(requestParameters.appId, requestParameters.endpointId, endpointUpdate, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const EndpointApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createOrUpdate(requestParameters: EndpointApiCreateOrUpdateRequest, options?: AxiosRequestConfig): AxiosPromise<EndpointOut> {
         ...
         * @throws {RequiredError}
         */
        getDetails(requestParameters: EndpointApiGetDetailsRequest, options?: AxiosRequestConfig): AxiosPromise<EndpointOut> {
         ...
         * @throws {RequiredError}
         */
        getSigningSecret(requestParameters: EndpointApiGetSigningSecretRequest, options?: AxiosRequestConfig): AxiosPromise<EndpointSecretOut> {
            return localVarFp.getSigningSecret(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get basic statistics for the endpoint.
         * @summary Endpoint Stats
         ...
         * @throws {RequiredError}
         */
        getStatistics(requestParameters: EndpointApiGetStatisticsRequest, options?: AxiosRequestConfig): AxiosPromise<EndpointStats> {
         ...
         * @throws {RequiredError}
         */
        resendFailedMessages(requestParameters: EndpointApiResendFailedMessagesRequest, options?: AxiosRequestConfig): AxiosPromise<RecoverOut> {
            return localVarFp.resendFailedMessages(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Rotates the endpoint\'s signing secret.  The previous secret will be valid for the next 24 hours.
         * @summary Rotate Endpoint Secret
         ...
         * @throws {RequiredError}
         */
        sendExampleMessageType(requestParameters: EndpointApiSendExampleMessageTypeRequest, options?: AxiosRequestConfig): AxiosPromise<MessageOut> {
            return localVarFp.sendExampleMessageType(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Set or unset the transformation code associated with this endpoint
         * @summary Set Endpoint Transformation
         ...
         * @throws {RequiredError}
         */
        setWebhookHeaders(requestParameters: EndpointApiSetWebhookHeadersRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.setWebhookHeaders(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an endpoint.
         * @summary Update Endpoint
         ...
         * @throws {RequiredError}
         */
        updateEndpointById(requestParameters: EndpointApiUpdateEndpointByIdRequest, options?: AxiosRequestConfig): AxiosPromise<EndpointOut> {
            return localVarFp.updateEndpointById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createOrUpdate operation in EndpointApi.
 * @export
 * @interface EndpointApiCreateOrUpdateRequest
 */
export type EndpointApiCreateOrUpdateRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiCreateOrUpdate
    */
...
/**
 * Request parameters for getDetails operation in EndpointApi.
 * @export
 * @interface EndpointApiGetDetailsRequest
 */
export type EndpointApiGetDetailsRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiGetDetails
    */
    readonly appId: string
...
/**
 * Request parameters for getSigningSecret operation in EndpointApi.
 * @export
 * @interface EndpointApiGetSigningSecretRequest
 */
export type EndpointApiGetSigningSecretRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiGetSigningSecret
    */
    readonly appId: string
...
/**
 * Request parameters for getStatistics operation in EndpointApi.
 * @export
 * @interface EndpointApiGetStatisticsRequest
 */
export type EndpointApiGetStatisticsRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiGetStatistics
    */
    readonly appId: string
...
/**
 * Request parameters for resendFailedMessages operation in EndpointApi.
 * @export
 * @interface EndpointApiResendFailedMessagesRequest
 */
export type EndpointApiResendFailedMessagesRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiResendFailedMessages
    */
    readonly appId: string
...
/**
 * Request parameters for sendExampleMessageType operation in EndpointApi.
 * @export
 * @interface EndpointApiSendExampleMessageTypeRequest
 */
export type EndpointApiSendExampleMessageTypeRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiSendExampleMessageType
    */
    readonly appId: string
...
/**
 * Request parameters for setWebhookHeaders operation in EndpointApi.
 * @export
 * @interface EndpointApiSetWebhookHeadersRequest
 */
export type EndpointApiSetWebhookHeadersRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiSetWebhookHeaders
    */
    readonly appId: string
...
/**
 * Request parameters for updateEndpointById operation in EndpointApi.
 * @export
 * @interface EndpointApiUpdateEndpointByIdRequest
 */
export type EndpointApiUpdateEndpointByIdRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof EndpointApiUpdateEndpointById
    */
    readonly appId: string
...
export class EndpointApiGenerated extends BaseAPI {
     ...
     */
    public createOrUpdate(requestParameters: EndpointApiCreateOrUpdateRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).createOrUpdate(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public getDetails(requestParameters: EndpointApiGetDetailsRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).getDetails(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public getSigningSecret(requestParameters: EndpointApiGetSigningSecretRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).getSigningSecret(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public getStatistics(requestParameters: EndpointApiGetStatisticsRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).getStatistics(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public resendFailedMessages(requestParameters: EndpointApiResendFailedMessagesRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).resendFailedMessages(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public sendExampleMessageType(requestParameters: EndpointApiSendExampleMessageTypeRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).sendExampleMessageType(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public setWebhookHeaders(requestParameters: EndpointApiSetWebhookHeadersRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).setWebhookHeaders(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EndpointApiGenerated
     */
    public updateEndpointById(requestParameters: EndpointApiUpdateEndpointByIdRequest, options?: AxiosRequestConfig) {
        return EndpointApiFp(this.configuration).updateEndpointById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
