...
export const ApplicationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateApplicationById: async (appId: string, applicationIn: ApplicationIn, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('updateApplicationById', 'appId', appId)
            // verify required parameter 'applicationIn' is not null or undefined
            assertParamExists('updateApplicationById', 'applicationIn', applicationIn)
            const localVarPath = `/api/v1/app/{app_id}`
                .replace(`{${"app_id"}}`, encodeURIComponent(String(appId !== undefined ? appId : `-app_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const ApplicationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Update an application.
         * @summary Update Application
         * @param {ApplicationApiUpdateApplicationByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateApplicationById(requestParameters: ApplicationApiUpdateApplicationByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApplicationOut>> {
            const applicationIn: ApplicationIn = {
                name: requestParameters.name,
                rateLimit: requestParameters.rateLimit,
                uid: requestParameters.uid,
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateApplicationById(requestParameters.appId, applicationIn, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ApplicationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateApplicationById(requestParameters: ApplicationApiUpdateApplicationByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ApplicationOut> {
            return localVarFp.updateApplicationById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for updateApplicationById operation in ApplicationApi.
 * @export
 * @interface ApplicationApiUpdateApplicationByIdRequest
 */
export type ApplicationApiUpdateApplicationByIdRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof ApplicationApiUpdateApplicationById
    */
    readonly appId: string
...
export class ApplicationApiGenerated extends BaseAPI {
     ...
     * @memberof ApplicationApiGenerated
     */
    public updateApplicationById(requestParameters: ApplicationApiUpdateApplicationByIdRequest, options?: AxiosRequestConfig) {
        return ApplicationApiFp(this.configuration).updateApplicationById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
