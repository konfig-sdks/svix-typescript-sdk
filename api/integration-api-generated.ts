...
export const IntegrationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listIntegrations: async (appId: string, limit?: number, iterator?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('listIntegrations', 'appId', appId)
            const localVarPath = `/api/v1/app/{app_id}/integration`
                .replace(`{${"app_id"}}`, encodeURIComponent(String(appId !== undefined ? appId : `-app_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        rotateIntegrationKey: async (appId: string, integId: string, idempotencyKey?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('rotateIntegrationKey', 'appId', appId)
            // verify required parameter 'integId' is not null or undefined
            assertParamExists('rotateIntegrationKey', 'integId', integId)
         ...
         * @throws {RequiredError}
         */
        updateIntegration: async (appId: string, integId: string, integrationUpdate: IntegrationUpdate, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
            assertParamExists('updateIntegration', 'appId', appId)
            // verify required parameter 'integId' is not null or undefined
            assertParamExists('updateIntegration', 'integId', integId)
            // verify required parameter 'integrationUpdate' is not null or undefined
            assertParamExists('updateIntegration', 'integrationUpdate', integrationUpdate)
            const localVarPath = `/api/v1/app/{app_id}/integration/{integ_id}`
                .replace(`{${"app_id"}}`, encodeURIComponent(String(appId !== undefined ? appId : `-app_id-`)))
                .replace(`{${"integ_id"}}`, encodeURIComponent(String(integId !== undefined ? integId : `-integ_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const IntegrationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listIntegrations(requestParameters: IntegrationApiListIntegrationsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListResponseIntegrationOut>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listIntegrations(requestParameters.appId, requestParameters.limit, requestParameters.iterator, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Rotate the integration\'s key. The previous key will be immediately revoked.
         * @summary Rotate Integration Key
         * @param {IntegrationApiRotateIntegrationKeyRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async rotateIntegrationKey(requestParameters: IntegrationApiRotateIntegrationKeyRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IntegrationKeyOut>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.rotateIntegrationKey(requestParameters.appId, requestParameters.integId, requestParameters.idempotencyKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update an integration.
         ...
         * @throws {RequiredError}
         */
        async updateIntegration(requestParameters: IntegrationApiUpdateIntegrationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IntegrationOut>> {
            const integrationUpdate: IntegrationUpdate = {
                name: requestParameters.name
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateIntegration(requestParameters.appId, requestParameters.integId, integrationUpdate, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const IntegrationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listIntegrations(requestParameters: IntegrationApiListIntegrationsRequest, options?: AxiosRequestConfig): AxiosPromise<ListResponseIntegrationOut> {
            return localVarFp.listIntegrations(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Rotate the integration\'s key. The previous key will be immediately revoked.
         * @summary Rotate Integration Key
         ...
         * @throws {RequiredError}
         */
        rotateIntegrationKey(requestParameters: IntegrationApiRotateIntegrationKeyRequest, options?: AxiosRequestConfig): AxiosPromise<IntegrationKeyOut> {
            return localVarFp.rotateIntegrationKey(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an integration.
         * @summary Update Integration
         ...
         * @throws {RequiredError}
         */
        updateIntegration(requestParameters: IntegrationApiUpdateIntegrationRequest, options?: AxiosRequestConfig): AxiosPromise<IntegrationOut> {
            return localVarFp.updateIntegration(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};
 ...
 */
export type IntegrationApiListIntegrationsRequest = {
...
/**
 * Request parameters for rotateIntegrationKey operation in IntegrationApi.
 * @export
 * @interface IntegrationApiRotateIntegrationKeyRequest
 */
export type IntegrationApiRotateIntegrationKeyRequest = {
    
    /**
    * The app\'s ID or UID
    * @type {string}
    * @memberof IntegrationApiRotateIntegrationKey
    */
    readonly appId: string
 ...
 */
export type IntegrationApiUpdateIntegrationRequest = {
...
export class IntegrationApiGenerated extends BaseAPI {
     ...
     * @memberof IntegrationApiGenerated
     */
    public listIntegrations(requestParameters: IntegrationApiListIntegrationsRequest, options?: AxiosRequestConfig) {
        return IntegrationApiFp(this.configuration).listIntegrations(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof IntegrationApiGenerated
     */
    public rotateIntegrationKey(requestParameters: IntegrationApiRotateIntegrationKeyRequest, options?: AxiosRequestConfig) {
        return IntegrationApiFp(this.configuration).rotateIntegrationKey(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof IntegrationApiGenerated
     */
    public updateIntegration(requestParameters: IntegrationApiUpdateIntegrationRequest, options?: AxiosRequestConfig) {
        return IntegrationApiFp(this.configuration).updateIntegration(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
