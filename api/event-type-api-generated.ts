...
export const EventTypeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        archive: async (eventTypeName: string, expunge?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eventTypeName' is not null or undefined
            assertParamExists('archive', 'eventTypeName', eventTypeName)
         ...
         * @throws {RequiredError}
         */
        getEventType: async (eventTypeName: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eventTypeName' is not null or undefined
            assertParamExists('getEventType', 'eventTypeName', eventTypeName)
            const localVarPath = `/api/v1/event-type/{event_type_name}`
                .replace(`{${"event_type_name"}}`, encodeURIComponent(String(eventTypeName !== undefined ? eventTypeName : `-event_type_name-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        list: async (limit?: number, iterator?: string, order?: Ordering, includeArchived?: boolean, withContent?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/event-type`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        partiallyUpdateEventType: async (eventTypeName: string, eventTypePatch: EventTypePatch, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eventTypeName' is not null or undefined
            assertParamExists('partiallyUpdateEventType', 'eventTypeName', eventTypeName)
            // verify required parameter 'eventTypePatch' is not null or undefined
            assertParamExists('partiallyUpdateEventType', 'eventTypePatch', eventTypePatch)
            const localVarPath = `/api/v1/event-type/{event_type_name}`
                .replace(`{${"event_type_name"}}`, encodeURIComponent(String(eventTypeName !== undefined ? eventTypeName : `-event_type_name-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        updateEventTypeName: async (eventTypeName: string, eventTypeUpdate: EventTypeUpdate, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eventTypeName' is not null or undefined
            assertParamExists('updateEventTypeName', 'eventTypeName', eventTypeName)
            // verify required parameter 'eventTypeUpdate' is not null or undefined
            assertParamExists('updateEventTypeName', 'eventTypeUpdate', eventTypeUpdate)
            const localVarPath = `/api/v1/event-type/{event_type_name}`
                .replace(`{${"event_type_name"}}`, encodeURIComponent(String(eventTypeName !== undefined ? eventTypeName : `-event_type_name-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const EventTypeApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Archive an event type.  Endpoints already configured to filter on an event type will continue to do so after archival. However, new messages can not be sent with it and endpoints can not filter on it. An event type can be unarchived with the [create operation](#operation/create_event_type_api_v1_event_type__post).
         * @summary Delete Event Type
         * @param {EventTypeApiArchiveRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async archive(requestParameters: EventTypeApiArchiveRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.archive(requestParameters.eventTypeName, requestParameters.expunge, options);
         ...
         * Get an event type.
         * @summary Get Event Type
         * @param {EventTypeApiGetEventTypeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getEventType(requestParameters: EventTypeApiGetEventTypeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventTypeOut>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEventType(requestParameters.eventTypeName, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Given an OpenAPI spec, create new or update existing event types. If an existing `archived` event type is updated, it will be unarchvied.  The importer will convert all webhooks found in the either the `webhooks` or `x-webhooks` top-level.
         ...
         * Return the list of event types.
         * @summary List Event Types
         * @param {EventTypeApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: EventTypeApiListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListResponseEventTypeOut>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.limit, requestParameters.iterator, requestParameters.order, requestParameters.includeArchived, requestParameters.withContent, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Partially update an event type.
         * @summary Patch Event Type
         * @param {EventTypeApiPartiallyUpdateEventTypeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async partiallyUpdateEventType(requestParameters: EventTypeApiPartiallyUpdateEventTypeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventTypeOut>> {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.partiallyUpdateEventType(requestParameters.eventTypeName, eventTypePatch, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update an event type.
         * @summary Update Event Type
         * @param {EventTypeApiUpdateEventTypeNameRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateEventTypeName(requestParameters: EventTypeApiUpdateEventTypeNameRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventTypeOut>> {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateEventTypeName(requestParameters.eventTypeName, eventTypeUpdate, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const EventTypeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        archive(requestParameters: EventTypeApiArchiveRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getEventType(requestParameters: EventTypeApiGetEventTypeRequest, options?: AxiosRequestConfig): AxiosPromise<EventTypeOut> {
            return localVarFp.getEventType(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Given an OpenAPI spec, create new or update existing event types. If an existing `archived` event type is updated, it will be unarchvied.  The importer will convert all webhooks found in the either the `webhooks` or `x-webhooks` top-level.
         * @summary Event Type Import From Openapi
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: EventTypeApiListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ListResponseEventTypeOut> {
         ...
         * @throws {RequiredError}
         */
        partiallyUpdateEventType(requestParameters: EventTypeApiPartiallyUpdateEventTypeRequest, options?: AxiosRequestConfig): AxiosPromise<EventTypeOut> {
            return localVarFp.partiallyUpdateEventType(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an event type.
         * @summary Update Event Type
         ...
         * @throws {RequiredError}
         */
        updateEventTypeName(requestParameters: EventTypeApiUpdateEventTypeNameRequest, options?: AxiosRequestConfig): AxiosPromise<EventTypeOut> {
            return localVarFp.updateEventTypeName(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for archive operation in EventTypeApi.
 * @export
 * @interface EventTypeApiArchiveRequest
 */
export type EventTypeApiArchiveRequest = {
    
    /**
    * The event type\'s name
    * @type {string}
    * @memberof EventTypeApiArchive
    */
...
/**
 * Request parameters for getEventType operation in EventTypeApi.
 * @export
 * @interface EventTypeApiGetEventTypeRequest
 */
export type EventTypeApiGetEventTypeRequest = {
...
/**
 * Request parameters for list operation in EventTypeApi.
 * @export
 * @interface EventTypeApiListRequest
 */
export type EventTypeApiListRequest = {
    
    /**
    * Limit the number of returned items
    * @type {number}
    * @memberof EventTypeApiList
    */
...
/**
 * Request parameters for partiallyUpdateEventType operation in EventTypeApi.
 * @export
 * @interface EventTypeApiPartiallyUpdateEventTypeRequest
 */
export type EventTypeApiPartiallyUpdateEventTypeRequest = {
    
    /**
    * The event type\'s name
    * @type {string}
    * @memberof EventTypeApiPartiallyUpdateEventType
    */
    readonly eventTypeName: string
...
/**
 * Request parameters for updateEventTypeName operation in EventTypeApi.
 * @export
 * @interface EventTypeApiUpdateEventTypeNameRequest
 */
export type EventTypeApiUpdateEventTypeNameRequest = {
    
    /**
    * The event type\'s name
    * @type {string}
    * @memberof EventTypeApiUpdateEventTypeName
    */
    readonly eventTypeName: string
...
export class EventTypeApiGenerated extends BaseAPI {
     ...
     */
    public archive(requestParameters: EventTypeApiArchiveRequest, options?: AxiosRequestConfig) {
        return EventTypeApiFp(this.configuration).archive(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EventTypeApiGenerated
     */
    public getEventType(requestParameters: EventTypeApiGetEventTypeRequest, options?: AxiosRequestConfig) {
        return EventTypeApiFp(this.configuration).getEventType(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EventTypeApiGenerated
     */
    public list(requestParameters: EventTypeApiListRequest = {}, options?: AxiosRequestConfig) {
        return EventTypeApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EventTypeApiGenerated
     */
    public partiallyUpdateEventType(requestParameters: EventTypeApiPartiallyUpdateEventTypeRequest, options?: AxiosRequestConfig) {
        return EventTypeApiFp(this.configuration).partiallyUpdateEventType(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EventTypeApiGenerated
     */
    public updateEventTypeName(requestParameters: EventTypeApiUpdateEventTypeNameRequest, options?: AxiosRequestConfig) {
        return EventTypeApiFp(this.configuration).updateEventTypeName(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
