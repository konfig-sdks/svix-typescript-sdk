...
export class Svix extends SvixCustom {
  ...
  constructor(configurationParameters: ConfigurationParameters = {}) {
    ...
    this.backgroundTasks = new BackgroundTasksApi(configuration);
    this.endpoint = new EndpointApi(configuration);
    this.eventType = new EventTypeApi(configuration);
    ...
    this.messageAttempt = new MessageAttemptApi(configuration);
